...
_G.ReportamusObjectFactory = require( 'ReportamusObjectFactory' )    -- class of object used to create objects of classes not mandated by the framework.
_G.objectFactory = ReportamusObjectFactory:new()               -- object used to create objects of classes not mandated by the framework.
...
_G.ReportamusManager = require( "ReportamusManager" )
_G.Reportamus = require( "Reportamus" )
_G.reportamus = Reportamus:new()



--   I N I T I A T E   A S Y N C H R O N O U S   I N I T   A N D   B A C K G R O U N D   T A S K
ReportamusManager.initPrefs() -- remember to include all dependent plugin prefs (plugin generator is not helping in this regard, yet)
_G.exifTool = ExifTool:new{ prefName="exifToolApp" }
