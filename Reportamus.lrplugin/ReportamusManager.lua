--[[
        ReportamusManager.lua
--]]


local ReportamusManager, dbg = Manager:newClass{ className='ReportamusManager' }
...
--]]
function ReportamusManager:newClass( t )
...
--]]
function ReportamusManager:new( t )
...
--
function ReportamusManager:_initGlobalPrefs()
    ...
    app:registerPreset( "Detailed - in default order", 2 )
    app:registerPreset( "Summary - ascending by use", 3 )
...
--
function ReportamusManager:_initPrefs( presetName )
    -- Instructions: uncomment to support these external apps in global prefs, otherwise delete:
...
-- 
function ReportamusManager:startDialogMethod( props )
...
--
function ReportamusManager:prefChangeHandlerMethod( _props, _prefs, key, value )
...
--
function ReportamusManager:propChangeHandlerMethod( props, name, value, call )
...
-- 
function ReportamusManager:sectionsForBottomOfDialogMethod( vf, props)
