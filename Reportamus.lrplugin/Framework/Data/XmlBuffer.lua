...
local XmlBuffer, dbg = Object:newClass{ className = 'XmlBuffer', register = true }
...
--
--  @usage If attribute does not exist, it will be created (changed 18/Mar/2013 4:25 - before that an error would be thrown) ###1 (check usage).
...
--
function XmlBuffer:parseToLua( xmlString, expectDecl )
