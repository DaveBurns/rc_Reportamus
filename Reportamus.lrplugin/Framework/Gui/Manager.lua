...
function Manager:prefChangeHandlerMethod( _id, _prefs, key, value, call )
    ...
    app:call( Call:new{ name="prefChangeHandlerMethod", async=true, guard=App.guardSilent, main=function( call ) -- ###4 changed to async fairly recently - delete comment if no issues come 2014.
