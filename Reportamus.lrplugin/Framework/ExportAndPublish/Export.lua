...
--- get export settings from an export preset file. ###1 note: does not yet support automatic detection of export preset folder.
--
...
function Export:getSettingsFromPreset( params )
    ...
    pcall( dofile, file ) -- let error propagate to caller.
...
function Export:getDestPath( props, photo, cache )
    ...
    local dir = self:getDestDir( photo, cache )
