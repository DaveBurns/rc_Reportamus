...
function LogFile:enable( t )
    ...
    -- ###1 Note: this is dangerous pref handling: really need to make sure plugin that previously did not use managed preferences does not block version that does, and vice versa.
