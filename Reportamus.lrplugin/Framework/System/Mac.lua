...
--[[
        May not work in Lion, may need: ###1
...
--- mac implementation of operating-system--make-folder-link. ###1 untested @5/Jul/2013 21:44
--
function Mac:makeFolderLink( linkPath, folderPath )
    local cmd = "ln"
    local parms = str:fmtx( '/s "^1"', folderPath )
...
--- windows implementation of operating-system--make-folder-link. ###1 untested @5/Jul/2013 21:44.
--
